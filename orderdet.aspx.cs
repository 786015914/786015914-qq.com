...
{
    public partial class orderdet : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string SqlStr = "select * from Cart1 where name='" + Session["UserName"] + "'";
            ...
            {
                string SqlStr = "select * from Cart1 where name='" + Session["UserName"] + "' and id='" + Request.QueryString["t"] + "'";
                SqlDataAdapter da = new SqlDataAdapter(SqlStr, sqlCon);
                //实例化数据集DataSet
                DataSet ds = new DataSet();
                da.Fill(ds, "flower");
        ...
        {
            Response.Redirect("orderdet.aspx?t="+TextBox2.Text);
