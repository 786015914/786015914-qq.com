<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cgpwd.aspx.cs" Inherits="flowershop.cgpwd" %>
...
<section>
    <div id="user_center">
        <div id="user_center_1">
            <div id="box2">密码重置</div>
            <div id="box">
            <div class="left" style="height: 200px">
                    <ul>
                        <li>▶&nbsp<asp:LinkButton ID="LinkButton1" runat="server">个人资料</asp:LinkButton>
                        </li>
                        <li>▶&nbsp<asp:LinkButton ID="LinkButton2" runat="server">重置密码</asp:LinkButton>
                        </li>
                        <li>▶&nbsp<asp:LinkButton ID="LinkButton3" runat="server">订单查询</asp:LinkButton>
                        </li>
