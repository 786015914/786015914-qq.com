<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adcenter.aspx.cs" Inherits="flowershop.adcenter" %>
        ...
        <div id="user_center_1">
            ...
            <div class="left" style="height: 200px">
                    <ul>
                        ...
                        <li>▶&nbsp<asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">问题反馈</asp:LinkButton>
                        </li>
                        <li>▶&nbsp<asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click">花卉管理</asp:LinkButton>
                        </li>
