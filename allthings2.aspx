<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="allthings2.aspx.cs" Inherits="flowershop.allthings2" %>
...
&nbsp;<ul class="hide"></ul>
            ...
            <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/img/order.png" OnClick="ImageButton3_Click" style="height: 20px; width: 20px;" />
...
" src="img/shop_car.png" alt=""/></a>&nbsp |&nbsp
    ...
    <div class="nav">
       ...
       <span> <span> <asp:LinkButton ID="LinkButton8" runat="server" OnClick="LinkButton8_Click">问答反馈</asp:LinkButton></span> </span> 
&nbsp;</div>
<!--首页主体-->
<section>
    <div class="fixed">
    ...
    <div id="body1">
     ...
     <div id="box4" ><div id="price_choice" style="border-width: 0px" >
        <div>用途分类:</div>
        <div id="first_price"><span id="second">
         <asp:LinkButton ID="LinkButton3" runat="server" ForeColor="#005AA0"  style="TEXT-DECORATION: none" OnClick="LinkButton3_Click" >情侣系列</asp:LinkButton></span></div>
        <div id="second_price"><span id="third_start">
             <asp:LinkButton ID="LinkButton4" runat="server" ForeColor="#005AA0"  style="TEXT-DECORATION: none" >生日系列</asp:LinkButton></span></div>
...
<!--首页尾部-->
<div class="footer" style="margin-top:80%">
<footer>
    <div class="footer1">
        <ul>
            <li>About Change
